...
const en = JSON.parse(fs.readFileSync(OUT + '/new_content_en.json', 'utf8'));
const frT = JSON.parse(fs.readFileSync(OUT + '/tr_new_fr.json', 'utf8'));
const deT = JSON.parse(fs.readFileSync(OUT + '/tr_new_de.json', 'utf8'));

const ORDER = [['snj', 19], ['enfance', 20], ['cepas', 21], ['fondseuropeens', 22], ['zesumme', 23]];
