...
const en = JSON.parse(fs.readFileSync(OUT + '/new_content2_en.json', 'utf8'));
const frT = JSON.parse(fs.readFileSync(OUT + '/tr2_fr.json', 'utf8'));
const deT = JSON.parse(fs.readFileSync(OUT + '/tr2_de.json', 'utf8'));

const ORDER = [['statec', 25], ['environnement', 26], ['syvicol', 27], ['research', 28]];
