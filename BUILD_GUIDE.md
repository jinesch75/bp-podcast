...
- **Current categories:** digital, social, housing, energy ("Environment & energy"), research ("Research & innovation"), agriculture ("Agriculture & food"), work, family, health, seniors, inclusion, safety, civic, crossborder. A category chip only appears once ≥1 episode uses it. (`housing` added with ep 17; `energy` added with ep 18 Klima-Agence and relabelled to "Environment & energy" when the emwelt.lu episode 26 joined it; `research` added with ep 28 Research Luxembourg.)
